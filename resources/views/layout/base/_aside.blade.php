...
<!-- later put if statements down for different users -->
            <ul class="menu-nav {{ Metronic::printClasses('aside_menu_nav', false) }}">
              ...
              @elseif (Session::get('UserType')=='Security')
              {{ Menu::renderVerMenu(config('menu_aside_mgsecurity.items')) }}
              @elseif (Session::get('UserType')=='Dock Security')
              {{ Menu::renderVerMenu(config('menu_aside_dock.items')) }}
              @elseif (Session::get('UserType')=='WH Manager')
              {{ Menu::renderVerMenu(config('menu_aside_manager.items')) }}
