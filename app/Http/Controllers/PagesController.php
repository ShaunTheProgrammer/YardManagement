...
class PagesController extends Controller
{
    ...
    public function dashboardsc()
    {
        $page_title = 'Security Dashboard';
        $page_description = 'Some description for the page';

        return view('pages.security.dashboardsc', compact('page_title', 'page_description'));
    }
    public function secgatein()
    {
        $page_title = 'Security Dashboard';
        $page_description = 'Some description for the page';

        return view('pages.security.secgatein', compact('page_title', 'page_description'));
    }
}
